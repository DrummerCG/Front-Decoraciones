...
const TermsAndConditions = () => {
  return (
    <TermsContainer>
      ...
      <Paragraph>Para utilizar este sitio web, usted afirma tener al menos dieciocho (18) años de edad y/o ser mayor de edad en la jurisdicción en la que reside y desde la cual accede al sitio web donde se establece la legalidad. La edad mínima requerida para el uso y navegación del sitio web puede ser menor de dieciocho (18) años. Si tiene menos de 18 años y/o está por debajo de la mayoría de edad legal en su jurisdicción de residencia y desde donde accede al sitio web, entonces solo está autorizado a utilizar el sitio web mediante navegación y NO puede realizar compras ni hacer uso de las funcionalidades específicas del sitio web, o con la excepción de estar autorizado por los padres o un adulto responsable encargado.
      </Paragraph>
